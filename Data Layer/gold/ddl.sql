...
CREATE TABLE dim_tmp (
    srk_tmp BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE dim_org_sup (
    srk_org_sup BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE dim_org_sol (
    srk_org_sol BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE dim_vjt (
    srk_vjt BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
...
CREATE TABLE dim_mtv (
    srk_mtv BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    motivo TEXT NOT NULL,
    UNIQUE (motivo)
);

CREATE TABLE fat_vgm (
    srk_fat_vgm BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
